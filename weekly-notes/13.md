...
- What does `useState()` do?:
  ...
  - in the example below, using the restructuring assignment, `useState(0)` causes `count` to be initilaized to 0, and it returns a function that is used to set the value of `count`
